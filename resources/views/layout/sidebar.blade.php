        ...
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <li class="active">
                        <a title="Landing Page" href="{{ asset('dashboard') }}" aria-expanded="false"><span class="educate-icon educate-home icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Dashboard</span></a>
                    </li>
                    {{-- <li>
                    ...
                    {{-- <li id="removable">
                        ...
                        <ul class="submenu-angle page-mini-nb-dp" aria-expanded="false">
                            ...
                            <li><a title="Lock" href="{{ route('lock') }}"><span class="mini-sub-pro">Lock</span></a></li>
                            <li><a title="Password Recovery" href="{{ route('passwordrecovery') }}"><span class="mini-sub-pro">Password Recovery</span></a></li>
